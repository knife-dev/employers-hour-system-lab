...
public class KMessageDialog extends JOptionPane {
    /**
    ...
    public KMessageDialog (String title, String message, dialogType type) {
    ...
    public KMessageDialog (String title, String message) {
